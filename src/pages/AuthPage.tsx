      ...
      <div className="flex-1 flex items-center justify-center bg-white dark:bg-[#000000] border-l border-blue-500/20 px-4 sm:px-6 py-12 min-h-screen">
        ...
        >
          ...
          <div className="flex items-center gap-3 my-5">
            ...
            <span className="font-mono text-xs text-slate-400 dark:text-blue-400/40">
          ...
          <div className="space-y-3 opacity-50 pointer-events-none">
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-400 dark:text-blue-400/40 hover:text-slate-600 dark:hover:text-blue-400 transition-colors"
              >
                {showPass ? (
            ...
            {!isSignUp && (
              <div className="text-right">
                <button className="font-sans text-xs text-blue-600 dark:text-blue-400 hover:underline">
                  Forgot password?
                </button>
              </div>
            )}
