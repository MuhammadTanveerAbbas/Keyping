...
export const dashInput =
 "h-10 rounded-lg border-slate-200 bg-white text-slate-900 placeholder:text-slate-400 focus-visible:ring-blue-500";

export const dashSelectTrigger =
 "h-10 rounded-lg border-slate-200 bg-white text-slate-900";

export const dashSelectContent =
 "bg-white border-slate-200";

export const dashTextarea =
 "rounded-lg border-slate-200 bg-white text-slate-900 placeholder:text-slate-400 focus-visible:ring-blue-500";

export const dashPrimaryBtn =
 "bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg border-0 shadow-sm";
